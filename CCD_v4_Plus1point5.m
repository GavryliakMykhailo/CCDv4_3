...
base_path ='D:\MyDoc\Programming\mathematik\MyProg\UshenkoOG\Results\17_08_26'; % Можете змінити на свій шлях
main_folder_name = 'krov_OY_5';
...
%     nearest_coords = find_contrast_nearest_neighbors(amp_total_0, "first_non_nan");
    nearest_coords = find_contrast_nearest_neighbors(amp_total_0, "col_step", 5);
