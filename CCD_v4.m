...
%     0, 2*pi - 6*pi/10, "0_2pi_minus_6pi_10";
%     0, 2*pi - 7*pi/10, "0_2pi_minus_7pi_10";
%     0, 2*pi - 8*pi/10, "0_2pi_minus_8pi_10";
%     0, 2*pi - 9*pi/10, "0_2pi_minus_9pi_10";
%     0, 2*pi - 10*pi/10, "0_2pi_minus_10pi_10";
];

base_path = 'D:\MyDoc\Programming\mathematik\MyProg\UshenkoOG\2025\temp';
...
for range_idx = 1:size(phase_ranges, 1)
    ...
    folderName = fullfile(base_path, 'Results_09_09', folder_suffix);
